...
export const FIRST_PAGE = {
  HEADER_IMAGE_HEIGHT: 280,      // The RECON branded header image (approx 33% of page)
  TITLE_BLOCK_HEIGHT: 140,       // Project name, address, report type
  PHOTO_STRIP_HEIGHT: 140,       // 3 thumbnail photos + margins
  CLIENT_INFO_HEIGHT: 100,       // Client, Address, Job # block
